...
""",
        ...
        [
            [
                InlineKeyboardButton("📚 Commands", url=f"https://telegra.ph/Music-Player---Command-List-11-23"), 
                InlineKeyboardButton("👥 Group", url="https://t.me/joinchat/V8WC12GU2h4zZjdl"),
            ]
        ]
    ),
)
        ...
        try:
            if member.id == BOT_ID:
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup([
                        [
                            InlineKeyboardButton("📣 Updates Channel", url="https://t.me/Tenkaifams")]
                        ]
                    )
                )
                return
...
📚 @Tenkai musicx_bot **allows you** to play music on groups through the new Telegram's video chats!
